...
describe('Commodity Trading', () => {
    ...
    before(() => {
        ...
        return adminConnection.createProfile('defaultProfile', {
            ...
            .then(() => {
                ...
                return businessNetworkConnection.connect('defaultProfile', 'test-network2', 'admin', 'adminpw');
            });
    });
    ...
    describe('#tradeCommodity', () => {
        ...
        it('should be able to trade a commodity', () => {
            ...
            const commodity = factory.newResource(NS, 'House', 'EMA');
            ...
            trade.commodity = factory.newRelationship(NS, 'House', commodity.$identifier);
            ...
            return businessNetworkConnection.getAssetRegistry(NS + '.House')
                .then((assetRegistry) => {
